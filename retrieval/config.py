...
from retrieval.indexing_pipeline_utils import get_director_and_country
...
class RetrievalExpsConfig:
    ...
    def __init__(self):
        ...
        self._text_to_embed_fn: Callable = get_director_and_country

        # Parámetros para la generación de embeddings

        self.model_name: str = "jaimevera1107/all-MiniLM-L6-v2-similarity-es"
